...
function gameOver() {
  ...
  const t = gameTime;
  let remark;
  if (t < 10) remark = '刚进门就被抬走了？弓箭手们还没热身呢！';
  else if (t < 20) remark = '嗯……至少你进了场，下次试试别站在箭靶子上？';
  else if (t < 30) remark = '看得出来你在认真躲了，路子对了，继续练！';
  else if (t < 40) remark = '已有几分章法，再磨练身法，假以时日必成大器。';
  else if (t < 50) remark = '身手不凡，江湖中人见你也要让出三分！';
  else if (t < 60) remark = '好一个铁骨铮铮的勇士！箭雨之中犹自岿然不动。';
  else if (t < 70) remark = '令群雄刮目相看！这般身法，当世鲜有人及。';
  else if (t < 80) remark = '此等勇武，足以载入江湖英雄谱！众人敬仰！';
  else if (t < 90) remark = '传闻中的绝世高手，今日竟得一见，三生有幸！';
  else if (t < 100) remark = '近乎神话！你已超脱凡尘，踏入传说中的武学之境。';
  else if (t < 110) remark = '仙人之姿！当世武林，唯你独尊！';
  else if (t < 120) remark = '登峰造极，无人可及！你便是这天下的第一！';
  else remark = '壮士立于千军万马之间，矢如骤雨而不能伤其分毫，虽力竭而殁，然英魂不灭，千古长存。天地为鉴，日月为证——此战，当为万世之传颂。';
  subtitle.textContent = remark;
